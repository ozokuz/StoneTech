...
public final class StoneTechForgeContent {
    ...
    public static final RegistryObject<GlobalLootModifierSerializer<?>> ADD_ITEM_SERIALIZER =  LOOT_MODIFIER_SERIALIZERS.register("add_item",AddItemModifier.Serializer::new);
